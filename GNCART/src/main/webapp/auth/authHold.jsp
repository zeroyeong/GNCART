...
<body>
		...
		<div class="container-fluid">
			<div class="container">
				...
				<div class="content">
					<div class="tableMenu">
						<div class="button">
							<a href="authHold.jsp"><button>대기</button></a> <a
								href="authApproval.jsp"><button>승인</button></a> <a
								href="authReturn.jsp"><button>반려</button></a>
						</div>
					</div>
					<form method="post" action="authChk.jsp" id="authForm">
						<table>
							...
							<tbody>
								...
								%>
								<tr class="authOnclick"
									onclick="javascript:<%=linkFunction%>(' <%=DOC_NO%> ')">
									<td><input type="checkbox" name="chk" class="myCheckbox"
										value="<%=LINE_NO%>,<%=VAC_NO%>,<%=BUS_NO%>"></td>
									<td><%=DOC_NO%></td>
									<td><%=DOC_NAME%></td>
									<td><%=MEM_NAME%></td>
									<td>
	...
	<form name="VACviewFrm" method="get">
		<input type="hidden" name="DOC_NO">
	</form>
	<form name="BUSviewFrm" method="get">
		<input type="hidden" name="DOC_NO">
	</form>
