...
<section class="home-section">
      ...
      <div class="card-body">
          ...
          <form method="post" action="noticeChk.jsp" id="noticeForm">
              <table id="example" class="table table-striped" style="width:100%">
                  ...
                  %>
                      <tr>
    					<td><input type="checkbox" name="chk" value="<%=NOT_NO%>"></td>
   						 <td><%=NOT_NO %></td>
              ...
              <div id="btns">
                ...
                <button type="button" onclick="submitForm()" style="color:white">삭제하기</button>
              </div> 
     		 </div>
  </div>
  </div>
  ...
  <from name="listFrm" method="post">
  </from>
  <form name="viewFrm" method="get">
  <input type="hidden" name="NOT_NO">
  </form>	
