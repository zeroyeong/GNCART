			...
			<div id="container">
				<div id="title">
					...
					<div id="writerInfo" style="text-align: right">
						<span>작성자 : <b><%=MEM_NAME %></b></span> <span>작성일 : <b><%=NOT_DATE %></b></span>
					</div>
				</div>
				...
				<table>
					...
					<tr>
						...
						<td colspan="3">
							<% if( NOT_FILENAME !=null && !NOT_FILENAME.equals("")) {%> <a
							href="javascript:down('<%=NOT_FILENAME%>')"><%=NOT_FILENAME%></a>
							&nbsp;&nbsp;<font color="blue">(<%=NOT_FILESIZE%>KBytes)
